...
namespace StupidTemplate.Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        internal static void VisualizeAura(Vector3 position, object threshold, Color red)
        {
            throw new NotImplementedException();
        }

        internal static void RPCProtection()
        {
            throw new NotImplementedException();
        }
        ...
        internal static float startX;
        internal static float startY;
        internal static float flySpeed;
        internal static float subThingyZ;
        internal static float subThingy;
        internal static Vector3 rightgrapplePoint;
        internal static bool leftGrab;
        internal static bool isLeftGrappling;
        internal static bool rightPrimary;
    }
}
